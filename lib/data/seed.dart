...
const List<_SeedCategory> _defaults = [
  ...
  _SeedCategory('Education', CategoryType.expense, 'book', 0xFF0D9488),
  _SeedCategory('Entertainment', CategoryType.expense, 'tv', 0xFFEC4899),
  _SeedCategory('Family', CategoryType.expense, 'users', 0xFF6366F1),
  ...
  _SeedCategory('Freelance', CategoryType.income, 'laptop', 0xFF0D9488),
  _SeedCategory('Business', CategoryType.income, 'trending-up', 0xFF22C55E),
  _SeedCategory('Gift', CategoryType.income, 'gift', 0xFFEC4899),
